<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="dto.BoardVO, java.util.*, dto.MemberVO" %>
	...
	<div class="body__container">
		<div class="section__review">
			<div class="review__inner">
				...
				<div class="btn-group">
					<% if (memberVO != null) { %>
					<a href="NonageServlet?command=applereviewwrite&model=${param.model}" class="btn">리뷰쓰기</a>
					<% } else {%>
				...
				<table class="reviewTable">
					...
					%>
							<tr>
								...
								<td><a href="NonageServlet?command=detailreview&company=apple"><%= data.getContent() %></a></td>

			...
			<div class="compare__group clearfix">
				<div class="float--left">
					<div class="group--left">
						<form action="NonageServlet?command=trycompare1&company=samsung" name="compare1" method="post">
				...
				<div class="float--right clearfix">
					<div class="group--right clearfix">
						<form action="NonageServlet?command=trycompare2&company=samsung" name="compare2" method="post">
